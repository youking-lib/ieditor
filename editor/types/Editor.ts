...
export interface PluginFunctions {
  ...
  getEditorRef(): Editor; // a function to get the editor reference
}
...
export interface EditorPlugin {
  ...
  // Extract<PluginFunctions, { getEditorState, setEditorState }>
  willUnmount?: (pluginFunctions: Pick<PluginFunctions, "getEditorState" | "setEditorState">) => void;
