...
import { proxies, defaultKeyBindings, defaultKeyCommands } from './CONST'
import { EditorPlugin, PluginFunctions } from './types/Editor'
import { PluginResolve, EditorStateModifier } from './utils'
...
export interface PluginEditorProps extends EditorProps {
  ...
  keyBindingFn?(e: SyntheticKeyboardEvent): DraftEditorCommand | null | undefined
 ...
 */
class PluginEditor extends Component<PluginEditorProps, PluginEditorState> {
  static propTypes = {
  ...
  componentDidMount() {
    const decorator = PluginResolve.resolveDecorators(
      this.props,
      this.getEditorState,
      this.onChange
    )
    ...
    this.onChange(EditorStateModifier.moveSelectionToEnd(editorState))
  }
  ...
  getPlugins = (): EditorPlugin[] => this.props.plugins.slice(0)
